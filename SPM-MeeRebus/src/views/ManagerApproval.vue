  ...
  return arrangements.value
    .filter((arrangement) => {
      ...
      const matchesSearch =
        ...
        (arrangement.reason_staff &&
          arrangement.reason_staff.toLowerCase().includes(searchLower)) ||
        (arrangement.reason_man &&
          arrangement.reason_man.toLowerCase().includes(searchLower));

      // Combine all filters
      return (
        matchesStatus && isAfterStartDate && isBeforeEndDate && matchesSearch
      );
    })
        ...
        <tbody>
          ...
          >
            ...
            <td
              :class="{
                'text-danger':
                  arrangement.status == '3' || arrangement.status == '2',
              }"
            >
            ...
            <td>
              ...
              <button
                ...
                @click="approveArrangement(arrangement.arrangement_id)"
              ...
              <button
                type="button"
                v-if="arrangement.status === 1 || arrangement.status === 0"
                @click="checkID(arrangement.arrangement_id)"
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <button
                        ...
                        class="btn btn-primary"
                        data-bs-dismiss="modal"
                        @click="withdrawArrangement(withdrawalReason)"
                      >
                        Submit
                      </button>
                    </div>
